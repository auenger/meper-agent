...
class MessageService:
    ...
    async def add_message(
        ...
        Args:
            ...
            display_content: 终端用户看到的展示文本（如推荐问题按钮文案）。
                LLM 上下文仍用 content；空则前端回退展示 content。
        ...
        if role == "user":
            ...
            if display_content:
                doc["display_content"] = display_content
